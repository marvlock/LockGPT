...
export interface GuestConversation { id: string; title: string; sessionId: string; tabId: number; documentId?: string; createdAt: number; evidence: 'submission-route'; confidence: 'verified'; cleanupStatus: 'unreviewed' | 'kept' | 'deleted' | 'failed'; }
